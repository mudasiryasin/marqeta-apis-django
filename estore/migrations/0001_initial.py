# Generated by Django 3.0.7 on 2022-03-17 12:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url_slug', models.SlugField(max_length=160, verbose_name='Product Slug')),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created Date')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='estore.Category', verbose_name='Product Categoy')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created Date')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='estore.Product', verbose_name='Product')),
            ],
        ),
    ]
